...
api: "GET https://api.backend.inconcertcc.com/engine/v1/api/auto-contact/batches"
auth: "key"
---
...
```bash cURL
curl --request GET \
  --url 'https://api.backend.inconcertcc.com/engine/v1/api/auto-contact/batches?page=0&size=10&sortField=createdAt&sortOrder=desc&status=archived&startDate=2026-08-31T22%3A00%3A00.000Z&endDate=2026-09-16T21%3A59%3A59.999Z' \
