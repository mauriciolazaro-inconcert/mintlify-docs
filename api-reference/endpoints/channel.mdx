...
<CardGroup cols={2}>
  <Card title="Crear sesión" icon="play" href="./channel-init">
    Abre una sesión de inferencia y recibe los eventos mediante SSE.
  </Card>
  <Card title="Enviar mensaje" icon="message" href="./channel-talk">
    Envía texto del usuario a una sesión activa.
  </Card>
  <Card title="Escuchar sesión" icon="radio" href="./channel-listen">
    Conecta un nuevo consumer al stream de una sesión existente.
  </Card>
  <Card title="Destruir sesión" icon="trash" href="./channel-destroy">
