...
Durante una transferencia a un agente humano, permite recuperar la información de la conversación para dar continuidad a la gestión.
...
Consulta [Obtener información de una conversación](./session-snapshot) para ver la URL completa, la autenticación y el acceso al contexto y al resumen de la conversación.
