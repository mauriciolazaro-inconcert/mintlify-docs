...
- Explora [**Comportamiento**](/core/agents/behavior) para profundizar en la lógica conversacional.
- Aprende a crear [**reportes avanzados**](../reporting/advanced-reports) con KPIs personalizados.
...
[Contacta a soporte](mailto:soporte@inconcertcx.com) o revisa el enlace de estado del servicio en la navegación global.
