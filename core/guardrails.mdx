---
title: Guardrails
description: Filtros de seguridad y estilo que controlan el contenido de las respuestas del agente. Incluye herencia, buenas prácticas y advertencias de rendimiento.
---

import { Callout } from "nextra-theme-docs"

# Guardrails (Moderadores)

Los **Guardrails** son **filtros automáticos** que se aplican a las respuestas generadas por un agente para **asegurar calidad, seguridad y cumplimiento**.  
Funcionan como una capa de control que revisa cada mensaje antes de ser enviado al usuario.
...
## Ejemplos de guardrails comunes
