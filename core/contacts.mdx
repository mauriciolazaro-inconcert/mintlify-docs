...
- Configura el [**Recepcionista**](/core/receptionist) para que utilice la red de Contactos de forma eficiente.
- Crea [**Tópicos**](/core/topics) para enrutar automáticamente según la intención del usuario.
- Usa el [**Playground**](/core/playground) para validar las rutas de transferencia antes de publicar.
