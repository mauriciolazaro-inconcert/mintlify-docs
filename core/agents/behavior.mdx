...
description: "El Comportamiento es el corazón de cada agente.
...
- Consulta [Bases de conocimiento](/knowledge/overview) para integrar información de respaldo en el guion.
