---
title: "Herramientas"
description: "Las Herramientas (Tools) son acciones o integraciones externas que un agente puede ejecutar durante una conversación.
...
## Herramientas publicadas en el Market

El **Market de aplicaciones** es el catálogo desde el que puedes añadir herramientas publicadas para servicios externos. Estas aplicaciones no constituyen un cuarto tipo de herramienta: proporcionan una configuración lista para conectar, autorizar y limitar desde la interfaz de Inagent.

Al instalar una aplicación, selecciona sus credenciales y habilita únicamente las operaciones y los recursos que necesita el agente. Consulta la [portada del Market](../tools/market/overview) y las guías de cada aplicación.
...
- Configura una herramienta publicada desde el [Market de aplicaciones](../tools/market/overview).
