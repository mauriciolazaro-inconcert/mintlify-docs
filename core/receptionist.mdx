...
- Define los [**Contactos**](/core/contacts) del equipo.
- Crea tópicos clave en [**Tópicos**](/core/topics) y conéctalos a reglas de enrutamiento.
- Prueba todo con [**Playground**](/core/playground) y luego [**Publica**](/core/publishing) con control de versiones.
