---
title: "Tópicos"
description: "Los Tópicos permiten que un agente de Inagent identifique automáticamente el tema o intención principal de cada mensaje de usuario.

Esta detección es asíncrona: se evalúa cada mensaje de manera independiente, sin depender del punto actual del guion. Cuando un tópico se detecta, puede ejecutar una o varias acciones definidas."
---
...
- **Elige el rango de coincidencia correcto**:
  - Usa _Normal_ para la mayoría de los casos.
  - Usa _Exacta_ solo cuando se requiera una frase literal (p. ej., códigos internos).
...
- Configura [**Contactos**](/core/contacts) para que las transferencias automáticas tengan destino válido.
- Diseña las [**Reglas**](/core/agents/behavior) que se activarán cuando se detecte cada tópico.
- Revisa los resultados en [**Reportes avanzados**](../reporting/advanced-reports) para medir su efectividad.
