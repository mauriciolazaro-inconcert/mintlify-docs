...
- [WhatsApp](../channels/whatsapp): canal conversacional de alta apertura (próximamente).
- [Instagram](../channels/instagram): integración con mensajes directos (próximamente).
- [Facebook Messenger](../channels/facebook-messenger): atención directa en Messenger (próximamente).
- [SMS](../channels/sms): envío y recepción de mensajes de texto (próximamente).

### Web

- [Webchat](../channels/webchat): chat embebido en sitios web.
