...
- **Combina las estadísticas en tiempo real** con [Reportes](../reporting/overview)\
  y [Reportes avanzados](../reporting/advanced-reports) para análisis históricos.

---

## Próximos pasos

- Explora [Supervisión de equipos](/supervision/overview) para intervenir en conversaciones específicas cuando las métricas lo requieran.
