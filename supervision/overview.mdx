...
- Combina los datos de sentimiento con [Reportes avanzados](../reporting/advanced-reports)\
...
- Explora esta sección para conocer las herramientas disponibles durante una conversación.
- Revisa [Susurros](./whisper), [Transferencias](./transfer) e [Intervenciones](./impersonate)\
