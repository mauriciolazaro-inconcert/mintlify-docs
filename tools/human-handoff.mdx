...
description: "La herramienta Transferencia a humano permite que un agente virtual de Inagent
...
- Configura los [**Contactos**](../core/contacts) que recibirán las conversaciones transferidas.
- Prueba la herramienta en el [**Playground**](../core/playground) para confirmar que los parámetros se envían correctamente.
